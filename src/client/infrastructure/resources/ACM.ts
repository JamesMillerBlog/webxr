...
export class ACM {
    ...
    constructor (certificateArn: string | undefined, profile: string, targetDomain: string, parent: Client) {
        ...
        if (certificateArn) {
            ...
            const hostedZoneId = aws.route53.getZone({ name: domainParts.parentDomain }, { async: true, parent }).then(zone => zone.zoneId);
